...
<head>
    ...
    <title>About Me | SyahriProject.id</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <a href="about.php" class="navbar-brand">About</a>
                </ul>
                <div class="d-flex">
            ...
            <div class="col-md-6">
                <main>
                    <div class="container">
                        ...
                        <div style="padding: 10px;">
                            ...
                            <div class="text-center mt-5">
                                <img src="img/me2.PNG" alt="" width="auto" height="200px" style="border-radius: 50%;" class="border p-1">
                            </div>
                            <br>
                            <h5 style="text-indent: 35px;" class="lh-lg">Halo semuanya, Nama saya Muhammad Alif Syah Akbar.
                                Saya seorang Web Developer sejak awal tahun 2021, Saya tinggal di Bogor, Indonesia. Teknologi utama saya adalah PHP Native dan TailwindCSS.
                                Teknologi Informasi telah menjadi passion dan hobi saya sejak saya berusia 18 tahun, dan saya menyukai komputer sejak saya masih kecil.
                                <br>
                                <br>
                                Selain coding, saya suka mendengarkan Musik. Genre favorit saya adalah Pop Punk, Post-hardcore, Metalcore, Nu-metal, dan Electronicore, dan inilah <a href="" class=" fw-bold" style=" color:black;"> My Music Playlist</a>.
                                <br>
                                <br>
                                Saya juga suka bermain game. Genre favorit saya adalah First Person Shooter Terkadang saya menonton Anime, tetapi saya lebih suka menonton Film dan serial barat. Saya menghabiskan banyak waktu di depan layar laptop/Ngoding dan di Facebook untuk berbagi meme dan shitpost.
                            </h5>
                        </div>
                        <br>
                        <br>
                    ...
                    <div class="text-center my-4">
                        <a href="/syahri-project/index.php" class="btn btn-dark">Back to Home</a>
                    </div>
                </main>
            </div>
        </div>
