...
$halaman = mysqli_query($conn, "SELECT * FROM events");
...
<head>
    ...
    <title>Events | SyahriProject.id</title>
    ...
    <div class="container-fluid sidebar-fixed">
        <div class="row ">
            <div class="col-md-3" id="gambar-me">
                <img src="img/me2.png" alt="" width="auto" height="100px" style="border-radius: 50%;">
                        ...
                        <div style="padding: 10px;">
                            ...
                            <?php if ($array >= 1) : ?>
                                <?php foreach ($halaman as $post) : ?>
                                    <div style="padding: 10px;">
                                        ...
                                        <img src="/syahri-project/events/img/<?= $post["gambar"]; ?>" alt="" height="auto" width="100%">
                                        <p style="font-style:italic; margin:10px 0px;">Mulai Acara : <?= (date("d F Y", strtotime($post['tanggal_mulai']))); ?> s\d <?= (date("d F Y", strtotime($post['tanggal_akhir']))); ?></p>
                                        <p><?= (substr($post['deskripsi'], 0, 250) . "..."); ?></p>
                                        <?php if ((date("d F Y", strtotime($post['tanggal_akhir']))) >= (date("d F Y", strtotime($post['tanggal_mulai'])))) : ?>
                                            <a href="/syahri-project/view-event.php?slug=<?= $post["slug"]; ?>" class="btn btn-dark">AYO IKUTAN!!</a>
                                        <?php else : ?>
                                            <a onclick="return alert('Event sudah Berakhir!!')" class="btn btn-danger">Yahhh Kamu Telat😪</a>
                                        <?php endif; ?>
                                    </div>
                                    <br>
                                    <br>
                            ...
                            <?php else : ?>
                                <div style="display: block; text-align: center; margin: 20px; padding: 10px;">
                                    <img src="/syahri-project/img/no-event.png" alt="" height="auto" width="70%" style="align-items: center;">
                                </div>
                            <?php endif; ?>
                        </div>
                        <br>
