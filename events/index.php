...
$posts = mysqli_query($conn, "SELECT * FROM events");
...
<head>
    ...
    <title>Events Manage | SyahriProject</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/syahri-project/events/index.php">Events</a>
                    </li>
                </ul>
                <div class="d-flex">
    ...
    <div class="container">
        ...
        <div class="d-flex p-2 justify-content-between">
            ...
            <?php if (($_SESSION["role_id"] == 3)) : ?>
                <div>
                    <a type="button" class="btn btn-dark" href="../events/tambah_event.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
            ...
            <?php else : ?>
                <div>
                    <a onclick="return alert('Maaf anda bukan SubAdmin.');" class="btn btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
                            <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z" />
                        </svg> Add Event
                    </a>
                </div>
        ...
        <?php else : ?>
            <div class="alert alert-info" role="alert">
                Maaf hanya SubAdmin yang bisa atur Events😊.
            </div>
        <?php endif; ?>
    </div>
