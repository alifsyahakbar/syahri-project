...
$jumlahData = count(query("SELECT * FROM tags"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerhalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;

$awalData = ($jumlahDataPerhalaman * $halamanAktif) - $jumlahDataPerhalaman;

$tags = mysqli_query($conn, "SELECT * FROM tags LIMIT $awalData, $jumlahDataPerhalaman");

$status = mysqli_fetch_assoc($tags);
...
if (isset($_POST["submit"])) {
    if (addTags($_POST) > 0) {
        ...
        document.location.href='/syahri-project/tags/index.php';
        </script>";
    } else {
        echo "<script>
...
<head>
    ...
    <title>Tags | SyahriProject</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/syahri-project/tags/index.php">Tags</a>
                    </li>
                    <li class="nav-item">
            ...
            <ul class="pagination justify-content-center">
                ...
                <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
                    <?php if ($i == $halamanAktif) : ?>
                        <li class="page-item"><a style="color: red; font-wight: bold;" class="page-link" href="?halaman=<?= $i; ?>"><?= $i; ?></a></li>
                    <?php else : ?>
